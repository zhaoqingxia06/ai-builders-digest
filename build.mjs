...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  /* ---------- theme switch ---------- */
  .theme-switch {
    position: fixed; bottom: 62px; right: 18px; z-index: 50;
    display: flex; gap: 2px; padding: 3px;
    background: #fff; border: 1px solid var(--border);
    border-radius: 4px; box-shadow: 0 1px 8px rgba(20, 40, 70, 0.1);
  }
  ...
  /* ---------- vintage newspaper theme (Monocle-style) ---------- */
  body[data-theme="press"] {
    --bg: #d8cfb8; --card: #f5efdf; --text: #211c12; --muted: #6e6550;
    --border: #d6cab0; --accent: #211c12; --soft: #ece3cc; --red: #211c12;
    --sans: Georgia, "Songti SC", "Noto Serif SC", serif;
  }
  body[data-theme="press"] { background: #d8cfb8; }
  body[data-theme="press"] .wrap {
    background: var(--card); max-width: 1120px; padding: 40px 44px 60px;
    box-shadow: 0 3px 30px rgba(70, 58, 34, 0.28);
  }
  body[data-theme="press"] .page-head { border-bottom: none; padding-bottom: 4px; }
  ...
  body[data-theme="press"] .story-deck {
    font-family: Georgia, "Songti SC", serif; font-style: italic;
    text-align: center; color: #3d372a;
  }
  body[data-theme="press"] .story-meta { text-align: center; text-transform: uppercase; }
  body[data-theme="press"] article {
    background: transparent; border: none; padding: 0;
  }
  body[data-theme="press"] article .lang {
    column-count: 2; column-gap: 30px; column-rule: 1px solid var(--border);
  }
  body[data-theme="press"] .story-head, body[data-theme="press"] .kw-row,
  body[data-theme="press"] .pullquote, body[data-theme="press"] article h3 {
    column-span: all;
  }
  body[data-theme="press"] article h3 {
    justify-content: center; font-size: 19px; letter-spacing: 0.12em;
    color: var(--text); border-bottom: none; margin-top: 1.6em;
    border-top: 1px solid var(--text); padding-top: 12px;
  }
  body[data-theme="press"] p.callout {
    background: transparent; border-left: none; border-radius: 0; padding: 0;
  }
  body[data-theme="press"] p.callout::first-letter {
  ...
  body[data-theme="press"] .pq-text { font-style: italic; }
  body[data-theme="press"] .pq-mark { font-family: Georgia, serif; }
  body[data-theme="press"] .kw {
    background: var(--text); border-color: var(--text); color: var(--card); font-weight: 700;
  }
  body[data-theme="press"] .avatar { filter: grayscale(1) contrast(1.06); }
  body[data-theme="press"] .src-link { color: var(--text); border-bottom-color: #b9ac8d; }
  body[data-theme="press"] .src-link:hover { color: var(--muted); }
  body[data-theme="press"] strong.num { color: var(--text); }
  body[data-theme="press"] article ol li::marker { color: var(--text); }
  body[data-theme="press"] .cal-btn { background: transparent; }
  body[data-theme="press"] .cal-cell.c1 { background: #ece4cf; }
  body[data-theme="press"] .cal-cell.c2 { background: #e0d5b9; }
  body[data-theme="press"] .cal-cell.c3 { background: #d2c5a2; }
  body[data-theme="press"] .cal-cell.c4 { background: #c1b289; }
  body[data-theme="press"] .cal-cell.c1 .dn,
  body[data-theme="press"] .cal-cell.c2 .dn,
  body[data-theme="press"] .cal-cell.c3 .dn,
  body[data-theme="press"] .cal-cell.c4 .dn { color: #453c28; }
  body[data-theme="press"] .cal-cell.today { outline-color: var(--text); }
  body[data-theme="press"] .cal-cell.today .dn { color: var(--text); }
  body[data-theme="press"] .cal-cell.sel { border-color: var(--text); }
  body[data-theme="press"] .sw-btn.on, body[data-theme="press"] .theme-btn.on {
    background: var(--text); color: var(--card);
  }
  body[data-theme="press"] .lang-switch, body[data-theme="press"] .theme-switch {
    background: var(--card); border-color: var(--border);
    box-shadow: 0 1px 8px rgba(70, 58, 34, 0.2);
  }
</style>
</head>
